...
function Bebidas () {
  return (
    ...
    <div style={{marginBottom:"8vh"}}>
      ...
      <ItemDBebidas  id="9" nome="Cerveja" desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit." preco={10.80} img="/imgs/cerveja.svg"/>
      <ItemDBebidas  id="10" nome="Cerveja" desc="Lorem ipsum dolor sit amet, consectetur adipiscing elit." preco={10.80} img="/imgs/cerveja.svg"/>
    </div>
  )
}
